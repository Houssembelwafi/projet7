...
void afficher_election(GtkWidget *liste,char *fname){
  ...
  GtkCellRenderer *renderer;
	...
	if(f == NULL){
			...
			gtk_list_store_append(store,&iter);
            		gtk_list_store_set(store,&iter,EID,e.id,EORIENTATION,e.orientation,EMUNIC,e.munic,ENOM,e.nom,ENOMCT,e.nomCT,ECINT,e.cinT,ENOMC1,e.nomC1,ECINC1,e.cinC1,ENOMC2,e.nomC2,ECINC2,e.cinC2,ENOMC3,e.nomC3,ECINC3,e.cinC3,ENBVOTES,nb,EDATE,dateFormat	,-1);
